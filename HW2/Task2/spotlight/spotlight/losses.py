...
def my_loss(positive_predictions, negative_predictions, mask=None):
    """
    ...
    #loss = (1.0 - F.sigmoid(positive_predictions.mean(dim=0) -
    #                        negative_predictions.mean(dim=0)))

    loss = positives_loss.mean() + negatives_loss.mean()
